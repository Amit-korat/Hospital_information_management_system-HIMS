                                        ...
                                        <div class="card-body">
                                            <form>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="row">
                                                    <div class="mb-3"><label class="form-label" for="phone_no"><strong>Phone Number</strong></label><input class="form-control" type="tel" id="phone_no" maxlength="10" placeholder="9876543210" name="phone_no"></div>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
